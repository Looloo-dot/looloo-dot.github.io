...
(function () {
  ...
  var KB = [
    ...
    { k: 'publication paper papers published wrote writing research output',
      a: 'Eight active papers, one published: "From Advisor to Voting Teammate" (ACM CHI 2026 workshop). Under review: "One Capability or Many?" and "The Price of Intelligence". In preparation: the EvalEval Coalition’s "Science of Evaluations" (aimed at TMLR) and his MMLU validity study. Plus a paper on classical test theory and LLM judges, and two SSRN working papers — automation risk and UK wages, and mandatory AI-risk disclosure in capital markets. The research section above has all of them.' },
