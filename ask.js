...
(function () {
  ...
  var KB = [
    ...
    { k: 'publication paper papers published wrote writing research output',
      a: 'Ten active papers, one published: "From Advisor to Voting Teammate" (ACM CHI 2026 workshop). Under review at NeurIPS 2026 workshops: "One Capability or Many?", the classical-test-theory paper on LLM judges, and "A Score Should Travel With Its Repair History". "When Should Neural Data Inform Welfare?" has an invited revise-and-resubmit at the Durham Economic Journal. "The Price of Intelligence" is to be submitted to FAccT 2027; the EvalEval "Science of Evaluations" and his MMLU study are in preparation; plus two SSRN working papers on automation-risk wages and AI-risk disclosure. The research section above has all of them.' },
    { k: 'price intelligence index inference cost faact hedonic',
      a: '"The Price of Intelligence" builds a quality-adjusted price index for AI inference: 782 models over 31 months, priced per unit of capability. Most of the decline — 87% — is invisible to standard matched-model methods. Pre-registered on OSF.' },
    ...
    { k: 'neural neuroeconomics welfare brain data policy durham',
      a: '"When Should Neural Data Inform Welfare?" is his critical framework for policy uses of neuroeconomics — it has an invited revise-and-resubmit at the Durham Economic Journal, and a preprint on arXiv.' },
