...
(function () {
  ...
  var KB = [
    ...
    { k: 'publication paper papers published wrote writing research output',
      a: 'Eleven active papers. "From Advisor to Voting Teammate" is published in the ACM CHI 2026 workshop proceedings on human–agent collaboration. Under review at NeurIPS 2026 workshops: "One Capability or Many?", "The Price of Intelligence", the classical-test-theory paper on LLM judges, and "A Score Should Travel With Its Repair History" — with full versions of the first two aimed at ICLR and FAccT 2027. "When Should Neural Data Inform Welfare?" is under review after an invited minor revision at the UCL Journal of Economics; the EvalEval "Science of Evaluations" and his MMLU study are in preparation; plus a conference paper on AI-risk disclosure (Explore Econ 2025, UCL) and an SSRN working paper on automation risk and UK wages. The research section above has all of them.' },
    { k: 'price intelligence index inference cost faact hedonic',
      a: '"The Price of Intelligence" builds a quality-adjusted price index for AI inference: 782 models over 31 months, priced per unit of capability. Most of the decline — 87% — is invisible to standard matched-model methods. Pre-registered on OSF; under review at the NeurIPS 2026 EconML workshop, with the full version aimed at FAccT 2027. Preprint on arXiv (2608.29843), with the dataset on Zenodo and Hugging Face.' },
    { k: 'capability factor iclr benchmark battery economic validity one many',
      a: '"One Capability or Many?" tests twelve benchmarks that claim to measure different skills across 421 model configurations — one factor carries 74.5% of the common variance. Under review at the NeurIPS 2026 TAE workshop, with the full version aimed at ICLR 2027. Preprint on arXiv (2608.29420); analysis plan registered on OSF; code and data on GitHub.' },
    ...
    { k: 'future work hidden labour labor international review octavia measurement evidence',
      a: '"Who Makes the Future of Work? Measurement, Hidden Labour and the Evidence on AI" is in preparation with Dr Joanna Octavia at UCL, funded by a UCL MAPS summer research internship and aimed at the International Labour Review. It asks who gets counted in the evidence base behind claims about AI and work.' },
    ...
    { k: 'neural neuroeconomics welfare brain data policy',
      a: '"When Should Neural Data Inform Welfare?" is his critical framework for policy uses of neuroeconomics — it is under review after an invited minor revision at the UCL Journal of Economics, with a preprint on arXiv.' },
    { k: 'disclosure signalling signal capital markets sec act firms regulation mandatory',
      a: '"Mandatory AI-Risk Disclosure as a Signalling Device in Capital Markets" is his conference paper, shortlisted and presented at Explore Econ 2025 at UCL: if firms must disclose AI risk, disclosure becomes a signal, analysed as a game of audits, costs and penalties under the EU AI Act and the SEC’s proposed rules.' },
