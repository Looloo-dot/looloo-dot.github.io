...
(function () {
  ...
  var KB = [
    ...
    { k: 'publication paper papers published wrote writing research output',
      a: 'Ten active papers, one published: "From Advisor to Voting Teammate" (ACM CHI 2026 workshop). Under review at NeurIPS 2026 workshops: "One Capability or Many?", the classical-test-theory paper on LLM judges, and "A Score Should Travel With Its Repair History". "When Should Neural Data Inform Welfare?" has an invited revise-and-resubmit at the UCL Journal of Economics. "The Price of Intelligence" is to be submitted to FAccT 2027; the EvalEval "Science of Evaluations" and his MMLU study are in preparation; plus two SSRN working papers on automation-risk wages and AI-risk disclosure. The research section above has all of them.' },
